        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                SizedBox(height: 50),
                Image.asset('lib/assets/registerAsset/vektorRegister2.png', height: 200),
                SizedBox(height: 20),
                Text("Let's complete your profile", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: Colors.black)),
                Text("It will help us to know more about you!", textAlign: TextAlign.center, style: TextStyle(fontSize: 16, color: Colors.grey[600])),
                SizedBox(height: 20),
                TextFormField(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      if (_formKey.currentState!.validate() && gender != null) {
                        final user = User(
                          user_id: 0, // Assuming user_id is generated by the backend
                          nama_depan: widget.firstName,
                          nama_belakang: widget.lastName,
                          password: widget.password,
                          email: widget.email,
                          profile_picture: '', // Add functionality to handle picture upload
